        ...
        <div class="container">
            <div class="row text-center intro-title">
                <div class="col-md-6 text-md-left d-inline-block">
                    <h1 class="text-white">Typography </h1>
                </div>
...
typography  -->
    ...
    <section class="typography-main page-section-ptb">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="typography">
                        ...
                        <div class="typography-teg">
                            <h5 class="title">Marked text</h5>
                            <span>You can use the mark tag to <mark>highlight</mark> text.</span>
                        </div>
                        <div class="typography-teg">
                            <h5 class="title">Deleted text</h5>
                            <del>This line of text is meant to be treated as deleted text.</del>
                        </div>
                        <div class="typography-teg">
                            <h5 class="title">Strikethrough text</h5>
                            <s>This line of text is meant to be treated as no longer accurate.</s>
                        </div>
                        <div class="typography-teg">
                            <h5 class="title">Underlined text</h5>
                    ...
                    <div class="ordered-lists">
                        <h4 class="title">Ordered Lists</h4>
                        <div class="row">
                            <div class="col-md-4">
                                <ol>
                    ...
                    <div class="unordered-lists">
                        <h4 class="title">Unordered Lists</h4>
                        <div class="row">
                            <div class="col-md-4">
                                <ul>
                                    <li>Lorem ipsum dolor sit amet. </li>
                            ...
                            <div class="col-md-4">
                                <ul class="list-style-1">
                                    ...
                                    <li><i class="fa fa-angle-right"></i> Consectetur adipisicing elit. </li>
                                    <li><i class="fa fa-angle-right"></i> Deserunt accusamus explicabo.</li>
                                    <li><i class="fa fa-angle-right"></i> Cumque voluptatum assumenda.</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- ================ -->
                    <div class="alerts">
                        <h4 class="title">Dismissible alerts</h4>
