            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="section-title">
                        <span>Apply now for right position</span>
                        <h2>career </h2>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="career-info">
                        ...
                        <p>Possimus dolorem perferendis deserunt lorem ipsum dolor sit amet, consectetur adipisicing elit. Reiciendis ab, iusto iste nesciunt doloremque voluptatibus? Mollitia, libero, culpa, ex odio nostrum at ducimus numquam harum laboriosam
                            explicabo ipsum atque dignissimos. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Rem enim dolor qui voluptates, sapiente exercitationem sequi commodi cum minus laborum at, doloribus dolores voluptatum necessitatibus.
                        </p>
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <ul class="list-style-1">
                                    ...
                                    <li><i class="fa fa-angle-right"></i> Sapiente exercitationem sequi commodi cum minus</li>
                                    <li><i class="fa fa-angle-right"></i> Necessitatibus ea possimus perferendis deserunt</li>
                                </ul>
                            </div>
                            <div class="col-md-6">
                                <h6>About Our Benefits</h6>
                                <ul class="list-style-1">
                                    <li><i class="fa fa-angle-right"></i> It's very important to us that we find the </li>
                                    <li><i class="fa fa-angle-right"></i> Reiciendis ab, iusto iste nesciunt doloremque</li>
                                    <li><i class="fa fa-angle-right"></i> Sapiente exercitationem sequi commodi cum minus</li>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <form class="gray-form">
                                    ...
                                    <p>Interested and eligible candidates are requested to fill below form to apply for the right position. Or send their CV together with personal details by e-mail address <a href="#"> support@yourwebsite.com </a></p>
