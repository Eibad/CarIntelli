                                            ...
                                            <div class="grid-row">
                                                ...
                                                <div class="grid-col-3">
                                                    <ul>
                                                        ...
                                                        <li class="active"><a href="page-both-sidebar.html">page both sidebar </a></li>
        ...
        <div class="container">
            <div class="row text-center intro-title">
                <div class="col-md-6 text-md-left d-inline-block">
                    <h1 class="text-white">page both sidebar </h1>
                </div>
                <div class="col-md-6 text-md-right float-right">
                    <ul class="page-breadcrumb">
                        <li><a href="#"><i class="fa fa-home"></i> Home</a> <i class="fa fa-angle-double-right"></i></li>
                        <li><a href="#">pages</a> <i class="fa fa-angle-double-right"></i></li>
                        <li><span>page both sidebar</span> </li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <section class="page-both-sidebar page-section-ptb">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4">
                    <h5>Page both sidebar</h5>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iste qui impedit, ut dolorem aspernatur mollitia veritatis quod! Deserunt molestiae distinctio doloremque sequi, perferendis, temporibus ad autem ab, quos et eos.Lorem ipsum
                        dolor sit amet, consectetur adipisicing elit. Iste qui impedit, ut dolorem aspernatur mollitia veritatis quod! Deserunt molestiae<br> <br> Distinctio doloremque sequi, perferendis, temporibus ad autem ab, quos et eos.Lorem ipsum
                        dolor sit amet, consectetur adipisicing elit. Iste qui impedit, ut dolorem aspernatur mollitia veritatis quod! Deserunt molestiae distinctio doloremque sequi, perferendis, temporibus ad autem ab, quos et eos.Lorem ipsum dolor sit
                        amet, consectetur adipisicing elit. Iste qui impedit, ut dolorem aspernatur mollitia veritatis</p>
                    <br>
                    <ul class="list-style-1">
                        <li> <i class="fa fa-angle-right"></i> Lorem ipsum dolor sit amet, consectetur </li>
                        <li> <i class="fa fa-angle-right"></i> Quidem error quae illo excepturi laboriosam </li>
                        <li> <i class="fa fa-angle-right"></i> Molestias, eum nihil odio dolorem</li>
                    ...
                    <br>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iste qui impedit, ut dolorem aspernatur mollitia veritatis quod! Deserunt molestiae distinctio doloremque sequi, perferendis, temporibus ad autem ab, quos et eos.Lorem ipsum
                        dolor sit amet, consectetur adipisicing elit. Iste qui impedit, ut dolorem aspernatur mollitia veritatis quod! Deserunt molestiae<br> <br> Distinctio doloremque sequi, perferendis, tempori tetur adipisicing elit. Iste qui impedit,
                        ut dolorem aspernatur mollitia veritatis quod! Deserunt mo ab, quos et eos.Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iste qui impedit, ut dolorem aspernatur mollitia veritatis</p>
                </div>
                <div class="col-md-4">
                    <div class="blog-sidebar">
                        <div class="sidebar-widget">
