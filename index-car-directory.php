...
<body>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <ul class="menu-links">
                                    ...
                                    <li class="active"><a href="javascript:void(0)"> Home <i class="fa fa-angle-down fa-indicator"></i></a>
                                        ...
                                        <ul class="drop-down-multilevel">
                                            ...
                                            <li class="active"><a href="index-car-directory.html"> Car directory</a></li>
                                ...
                                <ul class="submit-button float-right list-inline">
                                    ...
                                    <li> <a class="button" href="#"> Submit item </a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="slider-content text-center">
                            ...
                            <h4 class="text-white">Over <strong class="text-red">40000</strong> latest Cars in <strong class="text-red">Car Intelli</strong> </h4>
                            <div class="search-tab ">
                                <div id="tabs">
                                    ...
                                    <ul class="tabs text-left">
                                        ...
                                        <li data-tabs="tab4">Certified</li>
                                    </ul>
                        ...
                        <option>$35,000</option>
                                            ...
                                            <div class="col-lg-4 col-md-6">
                                                <div class="form-group">
                                                    <input id="name" type="text" placeholder="Location*" class="form-control placeholder" name="name">
                                                </div>
                                            </div>
                    ...
                    <div class="search-logo">
                        <div id="tabs" class="clearfix">
                            ...
                            <ul class="tabs float-right">
                                <li data-tabs="tab21" class="active"> BROWSE MAKE </li>
                                <li data-tabs="tab22"> BROWSE TYPE </li>
                            </ul>
                            ...
                            <div id="tab22" class="tabcontent">
                                <div class="row">
                                    <div class="col-lg-3 col-md-4">
                                        <a href="#">
                                            <div class="search-logo-box text-center">
                                                <img class="img-fluid center-block" src="images/clients/body-type/01.png" alt="">
                                    ...
                                    <div class="col-lg-3 col-md-4">
                                        <a href="#">
                                            <div class="search-logo-box text-center">
                                                <img class="img-fluid center-block" src="images/clients/body-type/02.png" alt="">
                                                <strong>coupe</strong>
                                            </div>
                                        </a>
                                    </div>
                                    <div class="col-lg-3 col-md-4">
                                        <a href="#">
                                            <div class="search-logo-box text-center">
                                                <img class="img-fluid center-block" src="images/clients/body-type/03.png" alt="">
                                                <strong>cuv</strong>
                                            </div>
                                        </a>
                                    </div>
                                    <div class="col-lg-3 col-md-4">
                                        <a href="#">
                                            <div class="search-logo-box text-center">
                                                <img class="img-fluid center-block" src="images/clients/body-type/04.png" alt="">
                                                <strong>micro</strong>
                                            </div>
                                        </a>
                                    </div>
                                    <div class="col-lg-3 col-md-4">
                                        <a href="#">
                                            <div class="search-logo-box text-center">
                                                <img class="img-fluid center-block" src="images/clients/body-type/05.png" alt="">
                                    ...
                                    <div class="col-lg-3 col-md-4">
                                        <a href="#">
                                            <div class="search-logo-box text-center">
                                                <img class="img-fluid center-block" src="images/clients/body-type/06.png" alt="">
                                    ...
                                    <div class="col-lg-3 col-md-4">
                                        <a href="#">
                                            <div class="search-logo-box text-center">
                                                <img class="img-fluid center-block" src="images/clients/body-type/07.png" alt="">
                                                <strong>sedan</strong>
                                            </div>
                                        </a>
                                    </div>
                                    <div class="col-lg-3 col-md-4">
                                        <a href="#">
                                            <div class="search-logo-box text-center">
                                                <img class="img-fluid center-block" src="images/clients/body-type/08.png" alt="">
            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-12">
                    <div id="tabs" class="clearfix">
                        ...
                        <ul class="tabs float-right">
                            <li data-tabs="tab10" class="active"> New Cars</li>
                            <li data-tabs="tab11"> USED CARS </li>
                        </ul>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="dealer-box red-bg">
                        <div class="box-content">
                            <h5 class="text-white">Ad your New car with Car Intelli</h5>
                ...
                <div class="col-md-6">
                    <div class="dealer-box dark-bg">
                        <div class="box-content">
                            <h5 class="text-white">Sell your Car with Car Intelli</h5>
                            <p class="text-white">Search Our Inventory With Thousands Of Cars And More Cars Are Adding On Daily Basis</p>
                            <a class="button white" href="#">Become a Dealer</a>
                        </div>
                        <div class="box-icon">
 ...
 latest news -->
    ...
    <section class="latest-blog gray-bg page-section-ptb">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <div class="text-left blog-button">
                        <h5>News & Reviews</h5>
                    </div>
                </div>
 ...
 footer -->
    ...
    <footer class="footer-3 footer-simple">
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <img id="logo-footer" class="img-fluid" src="images/logo-light.png" alt="">
                </div>
