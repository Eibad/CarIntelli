...
<body>
                                ...
                                <ul class="menu-links">
                                    ...
                                    <li class="active"><a href="javascript:void(0)"> Home <i class="fa fa-angle-down fa-indicator"></i></a>
                                        ...
                                        <ul class="drop-down-multilevel">
                                            ...
                                            <li class="active"><a href="index-10.html">Home 10</a></li>
 ...
 rev slider -->
    ...
    <section class="video-slider">
        <div id="video-background" class="bg-overlay-black" style="width: 100%;" data-vide-bg="mp4: video/video, webm: video/video, ogv: video/video, poster: video/video" data-vide-options="position: 0% 50%">
        </div>
                ...
                <div class="col-lg-8">
                    <div class="custom-block-content">
                        ...
                        <div class="content">
                            ...
                            <strong>Car Intelli is Most enticing, creative, modern and multipurpose auto dealer Premium WordPress Theme!  </strong>
                            <p>Car Intelli is the best premium WordPress Theme. We provide everything you need to build an <b> Amazing dealership website </b> developed especially for car sellers, dealers or auto motor retailers. </p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
 ...
 custom block -->
    ...
    <section class="custom-block-5 bg-9">
        <div class="container-fluid">
            <div class="row no-gutter">
                <div class="col-lg-6 bg-overlay-black-90">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="section-title text-left">
                                <span class="text-white">Build an amazing dealership website </span>
                                <h2 class="text-white">ABOUT Car Intelli </h2>
                                <div class="separator"></div>
                                <p class="text-white">Car Intelli is the best HTML5 template. We provide everything you need to build an Amazing dealership website developed especially for car sellers, dealers or auto motor retailers.</p>
                            </div>
                        </div>
                    </div>
...
clients -->
    ...
    <section class="our-clients page-section-pt">
        ...
        <div class="container-fluid">
            <img class="img-fluid center-block" src="images/objects/08.png" alt="">
        </div>
    </section>
