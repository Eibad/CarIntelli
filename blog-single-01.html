                                ...
                                <ul class="menu-links">
                                    ...
                                    <li class="active"><a href="javascript:void(0)">blog <i class="fa fa-angle-down fa-indicator"></i></a>
                                        ...
                                        <ul class="drop-down-multilevel">
                                            ...
                                            <li class="active"><a href="javascript:void(0)">blog single <i class="fa fa-angle-right fa-indicator"></i> </a>
                                                <!-- drop down second level -->
                                                <ul class="drop-down-multilevel">
                                                    <li class="active"><a href="blog-single-01.html">blog single 01 </a> </li>
                    ...
                    <div class="blog-entry">
                        ...
                        <div class="entry-content">
                            ...
                            <p>Aenean sollicitudin lorem ipsum dolor sit amet of Lorem Ipsum. Proin gravida nibh vel velit auctor aliquet. lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. Duis sed odio sit amet nibh vulputate
                                cursus a sit amet mauris. Morbi accumsan ipsum velit. Nam nec tellus a odio tincidunt pharetra.<br><br> Sagittis sem nibh lorem ipsum dolor sit amet of Lorem Ipsum. Proin graelit consequat ipsum, nec id elit. Duis sed odio
                                sit amet nibh vulputate cursus a sit amet mauris. Morbi accumsan ipsum velit. Nam nec tellus a odio tincidunt pharetra.</p>
                        </div>
